...
#ifndef VERSION
#define VERSION		"1.3.9"	/* default version */
#endif
#define VDATE		"Aug 15, 2000"	/* version date */
...
#define MAXINF		20	/* max number of input files */
...
#define SQ_NOTE 0x70
	...
	unsigned beam_break:1;	/* 1 if 2nd beam must restart here */
	...
	short	u, v, w, t;	/* auxillary information */
...
extern int insert_btype;	/* needed to split bars across lines */
